...
require get_template_directory() . '/includes/record-of-the-month-functions.php';
...
<main id="rotm" class="scroll-container">
  ...
  <footer class="promo">
    ...
    <p class="support_links">questions? <a href="http://help.vinylmeplease.com" target="_blank">reach out to support</a>, or find out <a href="<?php bloginfo('url'); ?>/how-it-works/" target="_blank">how this all works</a>
  </footer>
</main>
