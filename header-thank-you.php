...
<!-- Conversion Pixel - VinylMePlease -- Conversion - DO NOT MODIFY -->
<script src="https://secure.adnxs.com/px?id=493769&seg=2465386&order_id=<?php print($_GET["sub_id"]);?>&value=<?php print($_GET["amt"]);?>" type="text/javascript"></script>
...
{ event: "trackTransaction", id: "<?php print($_GET["sub_id"]);?>", item: [{ id: "1", price: <?php print($_GET["amt"]);?>, quantity: 1}] });
</script>
<!--End Criteo-->
...
<script>
    ...
    window['friendbuy'].push(['track', 'order',
      {
          id: '<?php print($_GET["sub_id"]);?>', //INPUT ORDER ID
          amount: '<?php print($_GET["amt"]);?>', //INPUT ORDER AMOUNT
    ...
    window['friendbuy'].push(['track', 'products',
      [
          {
              sku: 'SKU', //REPLACE WITH YOUR PRODUCT SKU,
              price: '0.00', //PUT YOUR PRODUCT PRICE,
              quantity: '0' //REPLACE WITH HOW MANY WERE BOUGHT, IF APPLICABLE
          }
          // You can add more product blocks like the one above here.
      ]
    ]);
</script>
<!--END FRIENDBUY CONVERSION-->
