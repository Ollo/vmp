<?php
/*
Template Name: Dedicated Sign Up - Harco
*/
    ...
    <div class='row'>
      <div class='col-md-1'></div>
        ...
        <?php while ( have_posts() ) : the_post(); ?>
          <h1><?php the_field('page-subheader'); ?></h1>
        <?php endwhile; // end of the loop. ?></p>
        			<div class='row'>
					<div class='col-sm-4'></div>
					<div class='col-sm-4'>
            <a class='btn btn-default navbar-btn full-width' href='https://vinylmeplease.chargebee.com/hosted_pages/plans/harco-6-month'>Sign Up <i class="fa fa-play-circle"></i></a>
					</div>
					<div class='col-sm-4'></div>
				</div>
				<!--End Row-->
